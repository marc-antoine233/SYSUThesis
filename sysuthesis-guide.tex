...
\author{1FCENdoge\thanks{Sino-French Institute of Nuclear Engineering and Technology, Sun Yat-sen University}\and
        Zeping Lee\thanks{School of Mathematical Sciences, USTC} }
\date{\today}
\maketitle
...
中山大学毕业论文模板（huangjj27 开发）以及本人的中山大学研究生学位论文 LaTeX 模板（试用）编写，
本人于2025年3月将几个模板整合梳理，新模板支持本科和研究生论文一键切换。
LaTeX PPT 模板目前由 wu-kan 制作中：\url{https://github.com/SYSU-SCC/sysu-thesis}
...
如果在使用的过程中遇到问题，可以阅读
\href{https://github.com/ustctug/sysuthesis/wiki}{常见问题}，
