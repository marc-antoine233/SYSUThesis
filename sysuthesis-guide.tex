...
\author{1FCENdoge\and
        Zeping Lee\thanks{zepinglee AT gmail.com} }
\date{v2.0.0-alpha1\qquad 2025-03-18}
\maketitle
...
模板编辑得到， 按照《中国科学技术大学研究生学位论文撰写手册》（最近在修订中）和
...
\begin{table}[htb]
  ...
  \begin{tabular}{lll}
    ...
    模板文件 & \file{sysuthesis.cls}     & 模板文件                     \\
             & \file{sysuthesis-*.bst}   & \BibTeX{} 参考文献表格式     \\
             & \file{figures/sysu-*.pdf} & 校名和校徽图片               \\
    \midrule
